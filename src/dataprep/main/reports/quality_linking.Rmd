...
- the lower bound on precision for the sample of chemists can be calculated as follows
  - 22% publish after PhD; assume they are all false positives 
  - of the remaining 78%, 87% publish at their graduating university
  - thus, our precision is at least 0.78 * 0.87 = 0.68
